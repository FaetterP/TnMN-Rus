...
const TEXT_LINE_01_ENGLISH = "Следующий короткометражный фильм производства D.D.D. служит для продвижения психического здоровья."
...
const TEXT_LINE_02_ENGLISH = "Здравствуйте.\nЕсли вы смотрите этот короткометражный фильм, значит мы заботимся о вашем психическом здоровье."
...
const TEXT_LINE_03_ENGLISH = "Наши сотрудники часто сталкиваются с повторяющимися кошмарами из-за психологической нагрузки, связанной с работой швейцара."
...
const TEXT_LINE_04_ENGLISH = "Вот почему мы рекомендуем вам воспользоваться услугами, предоставляемыми отделом психологии."
...
const TEXT_LINE_05_ENGLISH = "Наш медицинский персонал обучен помогать вам справляться с кошмарами."
...
const TEXT_LINE_07_ENGLISH = "Наш лучший сотрудник Генри настоятельно рекомендует эту услугу."
...
const TEXT_LINE_08_ENGLISH = "Он пользуется ею постоянно, даже когда его кошмары не прекращаются после сеансов."
...
const TEXT_LINE_06_ENGLISH = "Помните, что хороший сон важен для лучшей эффективности на работе."
