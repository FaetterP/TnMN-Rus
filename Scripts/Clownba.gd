...
var text_02_english = ["Хорошо.\nТеперь внимательно слушай, потому что я объясню правила только один раз.","Мы будем играть в карты. Победит тот, у кого закончится колода.","Мы будем ходить по очереди, и можно использовать только одну карту за ход.","Можно использовать только карту больше или равную текущей.","Или любую из джокеров J, Q, K, A.\nЭти карты можно играть всегда.","Любая карта побеждает джокера.","Если ты не можешь сыграть карту, тебе нужно взять одну из колоды.","Если ты можешь сыграть новую карту, тогда используй её.","Иначе твой ход заканчивается, пока у тебя не будет 6 карт.","Мы будем играть до двух побед из трёх.\nУдачи."]
...
var text_07_english = ["Может, в этот раз ты и выиграл. \nНо будет ещё одна возможность.","Мы снова встретимся, я в этом уверен.","И в следующий раз тебе может не повезти."]
