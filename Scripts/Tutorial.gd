...
const TEXT_LINE_01_ENGLISH = "Следующий короткометражный фильм производства D.D.D. служит в образовательных целях."
...
const TEXT_LINE_02_ENGLISH = "Здравствуйте.\nЕсли вы смотрите этот фильм, значит вы новый швейцар в своём доме."
...
const TEXT_LINE_03_ENGLISH = "Ваша работа состоит в том, чтобы определить, является ли человек, который хочет войти в здание, доппельгангером."
...
const TEXT_LINE_04_ENGLISH = "Как всем известно, доппельгангеры способны превращаться в другого человека и выдавать себя за него."
...
const TEXT_LINE_05_ENGLISH = "Но некоторые не слишком хороши в этом и могут содержать отклонения."
...
const TEXT_LINE_06_ENGLISH = "Вам нужно внимательно следить за внешностью своих соседей."
...
const TEXT_LINE_07_ENGLISH = "Также не забывайте заполнять контрольный список для каждого соседа."
...
const TEXT_LINE_08_ENGLISH = "Вы не можете пропустить ни одной детали, потому что это может означать смерть для вас и ваших соседей."
...
const TEXT_LINE_09_ENGLISH = "Это структура вашего офиса. Сейчас мы объясним, как он работает."
...
const TEXT_LINE_10_ENGLISH = "Здесь защитное окно, не забудьте внимательно наблюдать за каждым человеком, который приходит."
...
const TEXT_LINE_11_ENGLISH = "Справа у вас есть папки с данными всех соседей по соответствующему этажу."
...
const TEXT_LINE_12_ENGLISH = "Для заполнения списка проверки возьмите один из них перед собой."
...
const TEXT_LINE_13_ENGLISH = "Получайте документы через это окошко."
const TEXT_LINE_13_SPANISH = "Reciba documentos por esta ventanilla."
const TEXT_LINE_13_CHINESE = "通过该窗口接收文件。"
const TEXT_LINE_14_ENGLISH = "Если вы определите, что человек не является доппельгангером, то разрешите ему войти в дом с помощью этих кнопок."
...
const TEXT_LINE_15_ENGLISH = "Однако, если вы определите, что это действительно доппельгангер, нажмите кнопку экстренного вызова и позвоните 3312."
...
const TEXT_LINE_16_ENGLISH = "Для связи с D.D.D. или любой квартирой в вашем здании используйте телефон перед вами."
...
const TEXT_LINE_17_ENGLISH = "Ваша работа действительно важна, поэтому убедитесь, что вы выполняете её правильно."
...
const TEXT_LINE_18_ENGLISH = "Наконец, мы поздравляем швейцара месяца, Генри."
const TEXT_LINE_18_SPANISH = "Por último, felicitamos al portero del mes, Henry."
const TEXT_LINE_18_CHINESE = "最后，恭喜本月的门卫亨利。"
const TEXT_LINE_19_ENGLISH = "Не то чтобы он отлично справлялся, но он был единственным швейцаром в районе, которого не убили доппельгангеры."
