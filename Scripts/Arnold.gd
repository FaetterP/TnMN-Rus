		...
		match doppel_random:
			0: # Weird head
				if Global.language == SPANISH_VALUE:
					...
					doppel_dont_show_entry_text = ["Мне нужен разрешение на вход?","Мы соседи, ты меня знаешь.","Мне не нужно разрешение на вход, чтобы попасть домой."]
					...
					doppel_its_all_ok_text = ["Так что, всё в порядке?","Ты Можешь открыть для меня дверь?"]
				elif Global.language == CHINESE_VALUE:
			...
			2: # Long hair
				if Global.language == SPANISH_VALUE:
					...
					doppel_dont_show_id_text = ["Извините, да, я забыл показать свое удостоверение."]
					doppel_id_text = question_answers_english["id_ok"]
					doppel_appearance_text = ["Что не так с моей внешностью?", "Посмотри внимательно на фотографии моих документов и сравните их с моим внешним видом."]
					doppel_dont_show_entry_text = ["Я забыл показать своё разрешение на вход, вот оно."]
					doppel_entry_text = question_answers_english["entry_request_ok"]
					doppel_not_today_list_text = question_answers_english["today_list_ok"]
					doppel_today_list_text = question_answers_english["today_list_ok"]
					doppel_its_all_ok_text = ["Итак, все в порядке?", "Можешь открыть для меня дверь?"]
				elif Global.language == CHINESE_VALUE:
					doppel_dont_show_id_text = ["对不起，是的，我忘了出示我的身份证。"]
					doppel_id_text = question_answers_chinese["id_ok"]
					doppel_appearance_text = ["我的外貌有什么问题？","仔细看看我文件上的照片，然后将其与我好好比较一下。"]
		...
		match doppel_random:
			5: # All visually ok
				if Global.language == SPANISH_VALUE:
					...
					doppel_dont_show_entry_text = ["Я забыл показать своё разрешение на вход, вот оно."]
					doppel_entry_text = question_answers_english["entry_request_ok"]
					doppel_not_today_list_text = ["Меня нет в сегодняшнем списке, потому что мне пришлось уехать из-за экстренной ситуации на работе."]
					doppel_today_list_text = question_answers_english["today_list_ok"]
					doppel_its_all_ok_text = ["Так что, всё в порядке?", "Можешь открыть для меня дверь?"]
				elif Global.language == CHINESE_VALUE:
					doppel_dont_show_id_text = ["对不起，是的，我忘了出示我的身份证。"]
					doppel_id_text = question_answers_chinese["id_ok"]
			...
			6: # Mole
				if Global.language == SPANISH_VALUE:
					...
					doppel_dont_show_id_text = ["Извините, да, я забыл показать удостоверение."]
					doppel_id_text = question_answers_english["id_ok"]
					doppel_appearance_text = question_answers_english["appearance_ok"]
					doppel_dont_show_entry_text = ["Я забыл показать своё разрешение на вход, вот оно."]
					doppel_entry_text = question_answers_english["entry_request_ok"]
			...
			8: # no ddd
				if Global.language == SPANISH_VALUE:
					...
					doppel_dont_show_entry_text = ["Я забыл показать своё разрешение на вход, вот оно."]
					doppel_entry_text = question_answers_english["entry_request_ok"]
					doppel_not_today_list_text = ["Меня нет в сегодняшнем списке, потому что мне пришлось уйти из-за неотложного дела на работе."]
					doppel_today_list_text = question_answers_english["today_list_ok"]
