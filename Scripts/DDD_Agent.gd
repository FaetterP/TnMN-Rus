...
var text_3312_english = ["Протокол очистки завершён.", "Вы можете продолжать свою работу."]
...
var text_tutorial_english = ["Добро пожаловать и поздравляем с вашей новой работой.", "Как вы могли увидеть в вводном фильме, ваша задача - проверять жителей вашего здания.", "Каждый день будет список людей, которые будут хотеть войти.", "Возможно, будут люди, которые хотят войти и не находятся в списке.", "В таком случае отметьте в контрольном списке, что их нет, и допросите этого человека.", "Кроме того, вы должны проверить, что удостоверение личности и разрешение на вход правильные и имеют соответствующий логотип D.D.D.", "Не забудьте также проверить срок действия удостоверений (мм/гггг).", "Помните, сейчас февраль 1955 года.", "Желаю вам удачи."]
...
var text_tutorial_nigthmare_english = ["Вы знаете, что делать."]
